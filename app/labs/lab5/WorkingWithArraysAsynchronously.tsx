            ...
            <ListGroup>
                ...
                {todo.title}
                        ...
                        <FaPencil onClick={() => editTodo(todo)}
                                  className="text-primary float-end me-2 ms-auto" />
                        <TiDelete onClick={() => deleteTodo(todo)}
                                  className="text-danger float-end fs-3" id="wd-delete-todo" />
                        <FaTrash onClick={() => removeTodo(todo)}
                                 className="text-danger float-end me-2" id="wd-remove-todo" />
                    </ListGroupItem>
                ))}
            </ListGroup>
            <hr />
